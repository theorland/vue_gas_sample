...
DB.BALID_submitDraft = function(new_bal_val,proposal,quote){
...
DB.BALID_listAllDraftFile = function (){
  ...
  let one_week_before_s = moment().format(COMPARE_FORMAT);
