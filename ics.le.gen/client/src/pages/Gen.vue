<template>
  <div>
   <el-form ref="fgenerate" :model="form" label-width="120px" v-loading="is_loading"
    ...
    <el-form-item label="File Name" prop="created_by">
       <el-input v-model="form.filename" prop="filename"></el-input>
     </el-form-item>
     <el-form-item label="Submitted By" prop="created_by">
      <el-col :span="8">
      <el-select v-model="form.created_by" filterable placeholder="Who are you?" style="width:100%" >
        <el-option
     ...
     <el-form-item>
      ...
      <el-button type="primary" @click="onGenDoc" >Voucher Only</el-button>
   ...
   <el-dialog
    ...
    <el-link type="info" :href="result.proposal.url" :disabled="!result.proposal.has" target="_blank">Voucher</el-link></h4>
  ...
  methods : {
    ...
    loadAllQuoters : function(){
      ...
      this.bw.BALID_listQuoter(this.form.country).then(function(res){
        ...
        this.form.created_by = all_quoters[0].value;
        this.num_loading = this.num_loading-1;
    ...
    onGenBoth : function(){
      ...
      this.bw.BALID_createDraft(this.form.country,
                                this.form.filename, 
                                this.form.created_by, 3).then(function(res){
    ...
    onGenDoc : function(){
      ...
      this.bw.BALID_createDraft(this.form.country,
                                this.form.filename, 
                                this.form.created_by,2).then(function(res){
          this.result.proposal.has = true;
          this.result.proposal.url = res.proposal.url;
          this.result.proposal.filename = res.proposal.name;
    ...
    onGenSht : function(){
      ...
      this.bw.BALID_createDraft(this.form.country,
                                this.form.filename, 
                                this.form.created_by,1).then(function(res){
          this.result.quote.has = true;
          this.result.quote.url = res.quote.url;
          this.result.quote.filename = res.quote.name;
